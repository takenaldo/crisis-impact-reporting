...
SECRET_KEY = 'django-insecure-s#@*ox-p6&w(j+ff2#who#021!-1)@m5tcpdxo&6f4t!=$qp7j'  # noqa: E501
...
DEFAULT_BBOX_RADIUS_KM = float(os.environ.get('DEFAULT_BBOX_RADIUS_KM', '5'))


SPECTACULAR_SETTINGS = {
    'TITLE': 'CIR API',
    'DESCRIPTION': 'Interactive documentation for the CIR API',
    'VERSION': '1.0.0',
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),       # The prefix used in HTTP headers (e.g., 'Bearer <token>')
