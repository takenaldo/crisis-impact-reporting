...
export  function AnalyticsPage() {
  return (
    <Container size="xl" py="md" style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
      ...
      <Grid mb="xl">
        ...
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
          <Card padding="md" radius="md" withBorder={false} shadow="xs">
            <Group>
              <ThemeIcon color="teal.0" c="teal.6" size="xl" radius="xl">
                <IconTrendingUp size={24} />
              </ThemeIcon>
              <div>
                <Text size="xs" c="dimmed" fw={500}>Verification rate</Text>
                <Text size="xl" fw={700} c="teal.6">58%</Text>
              </div>
            </Group>
          </Card>
        </Grid.Col>
        ...
        {/* Weekly Velocity */}
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
          <Card padding="md" radius="md" shadow="xs">
            <Group>
              <ThemeIcon color="blue.0" c="blue.8" size="xl" radius="xl">
                <IconActivity size={24} />
              </ThemeIcon>
              <div>
                <Text size="xs" c="dimmed" fw={500}>Weekly velocity</Text>
                <Text size="xl" fw={700} c="#0f2d59">329</Text>
              </div>
            </Group>
          </Card>
        </Grid.Col>
        ...
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
          <Card padding="md" radius="md" shadow="xs">
            <Group>
              <ThemeIcon color="orange.0" c="orange.7" size="xl" radius="xl">
                <IconAlertTriangle size={24} />
              </ThemeIcon>
              <div>
                <Text size="xs" c="dimmed" fw={500}>Risk index</Text>
                <Text size="xl" fw={700} c="orange.7">7.8</Text>
              </div>
            </Group>
          </Card>
        </Grid.Col>
        ...
        <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
          <Card padding="md" radius="md" shadow="xs">
            <Group>
              <ThemeIcon color="orange.0" c="orange.5" size="xl" radius="xl">
                <IconClock size={24} />
              </ThemeIcon>
              <div>
                <Text size="xs" c="dimmed" fw={500}>Median closure</Text>
                <Text size="xl" fw={700} c="orange.5">9.6h</Text>
              </div>
            </Group>
          </Card>
        </Grid.Col>
