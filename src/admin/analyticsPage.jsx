      ...
      <Container size="xl">
        ...
        >
          <Flex align="center" gap="xs">
            <Text size="xs" c="dimmed" fw={700} style={{ letterSpacing: 1 }}>
              UNDP / Africa
            </Text>
            <Title order={3} c="#0f2d59" style={{ fontFamily: "sans-serif" }}>
              Analytics
            </Title>
          </Flex>
        ...
        <Grid mb="xl">
          ...
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card padding="lg" radius="md" shadow="xs" h={400}>
              <Text fw={700} size="md" c="#0f2d59">
                Submission + Verification Trend
              </Text>
              <Text size="xs" c="dimmed" mb="xl">
                Submissions vs verifications · last 7 days
              </Text>
        ...
        <Grid>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card padding="lg" radius="md" shadow="xs">
              <Text size="xs" c="dimmed" fw={500}>
                Predictive signal 01
              </Text>
              <Text fw={700} size="md" c="#0f2d59" mb="md">
                Lake Victoria basin
              </Text>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card padding="lg" radius="md" shadow="xs">
              <Text size="xs" c="dimmed" fw={500}>
                Predictive signal 02
              </Text>
              <Text fw={700} size="md" c="#0f2d59" mb="md">
                Dadaab health cluster
              </Text>
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card padding="lg" radius="md" shadow="xs">
              <Text size="xs" c="dimmed" fw={500}>
                Predictive signal 03
              </Text>
              <Text fw={700} size="md" c="#0f2d59" mb="md">
                Mombasa logistics corridor
              </Text>
