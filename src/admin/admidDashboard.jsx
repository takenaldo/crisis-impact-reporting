...
export function CrisisImpactAdminDashboard() {
  ...
  const renderActivePage = () => {
    switch (activeTab) {
      ...
      case 'Crisis Map': return <CrisisMapPage />;
    ...
    <AppShell
      ...
      styles={{
        ...
        main: {
          height: '100vh',
          overflowY: 'auto',
          paddingLeft: `calc(var(--app-shell-navbar-offset, 0rem) + ${rem(16)})`,
          scrollbarWidth: 'none',
      ...
      >
        ...
        <Box py="lg" px="sm" mb="md" style={{ borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          <Group align="center" gap="sm">
            ...
            <Stack gap={0}>
              <Title fw={800} size="h4" lh={1} style={{ color: 'white', letterSpacing: '-0.02em' }}>
                Crisis Impact
              </Title>
            ...
            <NavLink
              ...
              styles={{
                root: {
                  ...
                  backgroundColor: activeTab === item.label ? colors.teal : 'transparent',
                  padding: `${rem(10)} ${rem(12)}`,
                  '&:hover': {
                    backgroundColor: activeTab === item.label ? colors.teal : 'rgba(255,255,255,0.05)',
                  },
                },
                label: { fontWeight: activeTab === item.label ? 600 : 400, color: 'white' },
              }}
            />
          ))}
        </Stack>
